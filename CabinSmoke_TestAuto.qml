...
Item {
    ...
    Timer {
        ...
        onTriggered:{
            if (Cabin_Smoke.q_run_system_state){
                bIsRun = true;
                x_var ++;
                lineSeries.append(x_var, Cabin_Smoke.q_density_smoke);
                lineSeries1.append(x_var, Cabin_Smoke.threshold_matdokhoi);
                //
                //axisY.max = 10.5 + 5.0;
                //axisY.min = -2;
                    ...
                    GroupBox {
                        ...
                        RowLayout {
                            ...
                            Textinput {
                                ...
                                width: 65
                                height: 40
                                text: Cabin_Smoke.threshold_timeout //"120"
                                font.pointSize: 14
                                backgroundColor: "#a3a6b2"
                    ...
                    GroupBox {
                        ...
                        ColumnLayout {
                            ...
                            Textinput {
                                id: textinput
                                y: -1
                                text: Cabin_Smoke.q_volt_sensor_supply.toFixed(2)
                                Layout.fillWidth: true
                                font.pointSize: 14
                                Layout.preferredHeight: 30
